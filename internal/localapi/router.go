...
func (r *Router) setupRoutes() {
	...
	r.mux.HandleFunc("/v3/deploy/registries/", chainMiddleware(withRoute("/v3/deploy/registries/", r.v3Handler.HandleDeployRegistries), authMiddlewareV3, accessLoggingMiddleware, requestIdMiddleware))
	r.mux.HandleFunc("/v3/deploy/runtimeclasses:apply", chainMiddleware(withRoute("/v3/deploy/runtimeclasses:apply", r.v3Handler.HandleDeployRuntimeClassesApply), authMiddlewareV3, accessLoggingMiddleware, requestIdMiddleware))
	r.mux.HandleFunc("/v3/deploy/runtimeclasses:apply/", chainMiddleware(withRoute("/v3/deploy/runtimeclasses:apply/", r.v3Handler.HandleDeployRuntimeClassesApplyStatus), authMiddlewareV3, accessLoggingMiddleware, requestIdMiddleware))
	r.mux.HandleFunc("/v3/deploy/runtimeclasses:delete/", chainMiddleware(withRoute("/v3/deploy/runtimeclasses:delete/", r.v3Handler.HandleDeployRuntimeClassesDeleteStatus), authMiddlewareV3, accessLoggingMiddleware, requestIdMiddleware))
	r.mux.HandleFunc("/v3/deploy/runtimeclasses:validate", chainMiddleware(withRoute("/v3/deploy/runtimeclasses:validate", r.v3Handler.HandleDeployRuntimeClassesValidate), authMiddlewareV3, accessLoggingMiddleware, requestIdMiddleware))
	r.mux.HandleFunc("/v3/deploy/runtimeclasses", chainMiddleware(withRoute("/v3/deploy/runtimeclasses", r.v3Handler.HandleDeployRuntimeClasses), authMiddlewareV3, accessLoggingMiddleware, requestIdMiddleware))
	r.mux.HandleFunc("/v3/deploy/runtimeclasses/", chainMiddleware(withRoute("/v3/deploy/runtimeclasses/", r.v3Handler.HandleDeployRuntimeClasses), authMiddlewareV3, accessLoggingMiddleware, requestIdMiddleware))
