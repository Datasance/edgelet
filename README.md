...
scripts/release-binaries.sh v1.0.0-rc.4
```
...
make release-binaries VERSION=v1.0.0-rc.4
```
...
```bash
curl -fsSL https://github.com/eclipse-iofog/edgelet/releases/download/v1.0.0-rc.4/install.sh -o install.sh
chmod +x install.sh
...
```bash
curl -fsSL https://github.com/Datasance/edgelet/releases/download/v1.0.0-rc.4/install.sh -o install.sh
chmod +x install.sh
sudo ./install.sh --version=v1.0.0-rc.4
```
