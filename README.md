...
scripts/release-binaries.sh v1.0.0-rc.2
```
...
make release-binaries VERSION=v1.0.0-rc.2
```
...
```bash
curl -fsSL https://github.com/eclipse-iofog/edgelet/releases/download/v1.0.0-rc.2/install.sh -o install.sh
chmod +x install.sh
sudo ./install.sh --version=v1.0.0-rc.2
...
```bash
curl -fsSL https://github.com/Datasance/edgelet/releases/download/v1.0.0-rc.2/install.sh -o install.sh
chmod +x install.sh
sudo ./install.sh --version=v1.0.0-rc.2
```
